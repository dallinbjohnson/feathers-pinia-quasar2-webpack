...
class wpbElements extends BaseModel {
  ...
  static modelName = 'wpbElements';

  static diffOnPatch(data) {
    console.log('diffOnPatch data', data);
    if (data['_id']) {
      const originalObject = wpbElements.store.state['wpb-elements'].keyedById[data['_id']];
...
const servicePath = 'wpb-elements';
