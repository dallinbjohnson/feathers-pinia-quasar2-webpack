      ...
      columns() {
        return [
          ...
          },
          {
            ...
            label: 'Start Date',
            align: 'left',
            field: row => date.formatDate(row.startDate, 'DD-MM-YYYY hh:mm A'),
            format: val => `${val}`,
            sortable: true,
          },
          {
            ...
            label: 'End Date',
            align: 'left',
            field: row => date.formatDate(row.endDate, 'DD-MM-YYYY hh:mm A'),
            format: val => `${val}`,
            sortable: true,
          },
          {
            ...
            label: 'Close Date',
            align: 'left',
            field: row => date.formatDate(row.closeDate, 'DD-MM-YYYY hh:mm A'),
            format: val => `${val}`,
            sortable: true,
          },
          {
