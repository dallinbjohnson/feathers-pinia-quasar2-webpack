  ...
  <q-page class="ub-page">
    <div class="row items-center">
      <div class="col-md-12 q-ma-xs">
        <div class="text-h3">Sample Four</div>
      </div>
    </div>
    <div class="row items-center">
      <div class="col-md-12 q-ma-xs">
...
<script>
  // import { vgtMethods } from 'src/mixins/vgtmethods';
  import HTable from 'components/tables/htable.vue';
  import { demodashboard } from 'src/mixins/demodashboard';
  import PTableData from 'src/data/ptabledata.json';
  import ItemsTableData from 'src/data/itemstabledata.json';
  import HitsData from 'src/data/hitsdata.json';
