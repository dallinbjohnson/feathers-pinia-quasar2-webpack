  ...
  <q-page class="ub-page">
    <div class="row items-center" style="margin-bottom: 10px;">
      <div class="col-md-12 q-ma-sm">
        <div class="text-h3">Sample Three</div>
        <div class="text-subtitle1">
          Sample to see this dashboard in action
        </div>
      </div>
    </div>
...
<script>
  ...
  import utils from 'src/utils/dashblocks.js';

  // File '../data/summary.json' contains example dashboard data
  import dashboardData from 'src/data/summary.json';
  import {demodashboard} from 'src/mixins/demodashboard';
        ...
        dbspec: {
          ...
          widgets: [
            ...
            },
            {
              ...
              type: 'DbNumber',
              cspan: 2,
              properties: {title: 'Requests', subtitle: 'Total requests received', icon: 'fa fa-signal'},
            },
            {
            ...
            },
            {
              ...
              type: 'DbNumber',
              cspan: 2,
              properties: {title: 'Memory', subtitle: 'heapUsed', format: '%.2f %s', icon: 'fa fa-sd-card'},
            },
            ...
            {id: 'w11', type: 'DbNumber', cspan: 2, properties: {title: '5XX', subtitle: 'Server Error Responses'}},
            {
              ...
              properties: {
                ...
                subtitle: 'Current Event Loop Lag',
                format: '%.3f ms',
    ...
    methods: {
      ...
      updateStats: function () {
        ...
        this.dbdata.setWData('w7', {
          value: pathOr(0, ['all', 'errors'], statsContainer),
          trend: trendsData[6],
          trendMax: reqTrendMax,
          total: requestsTotal,
        });
        this.dbdata.setWData('w8', {
          value: pathOr(0, ['all', 'success'], statsContainer),
          trend: trendsData[7],
          trendMax: reqTrendMax,
          total: requestsTotal,
        });
        this.dbdata.setWData('w9', {
          value: pathOr(0, ['all', 'redirect'], statsContainer),
          trend: trendsData[8],
          trendMax: reqTrendMax,
          total: requestsTotal,
        });
